package net.dajman.villagershop.data.configuration;
...
public class Config {
    ...
    public void load(){
        ...
        if (this.configFile.exists()){
            ...
            if (!Objects.equals(CONFIG_VERSION, configVersion)){
                if (!this.configFile.renameTo(new File(this.plugin.getDataFolder(), OLD_CONFIG_FILE_NAME))
                    ...
                    LOGGER.warn("load() Cannot rename and delete the configuration file to create a new one," +
        ...
        LOGGER.info("load() The configuration has been loaded");
    }
