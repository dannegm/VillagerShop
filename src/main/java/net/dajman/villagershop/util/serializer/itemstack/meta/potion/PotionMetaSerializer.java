package net.dajman.villagershop.util.serializer.itemstack.meta.potion;
...
public class PotionMetaSerializer implements Serializer<PotionMeta, Map<String, Object>> {
    ...
    public Optional<Map<String, Object>> serialize(PotionMeta potionMeta) {
        ...
        try{
            ...
            LOGGER.debug("serialize() Catch exception={} while trying to get customColor from PotionMeta. {}",
                    getMessage(e));
        }
        ...
        if (optionalItemMeta.isPresent()){
            ...
            optionalCustomColorRGB.ifPresent(customColorRGB -> {
                try {
                    ...
                    LOGGER.debug("deserialize() Catch exception={} while trying to set customColor of PotionMeta. {}",
                            getMessage(e));
                }
            });
